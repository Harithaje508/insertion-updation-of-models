"""
URL configuration for threetables project.
...
urlpatterns = [
    ...
    path('newdisplaytopic/',newdisplaytopic,name='newdisplaytopic'),
    path('newdisplaywebp/',newdisplaywebp,name='newdisplaywebp'),
    path('newdisplayaccessr/',newdisplayaccessr,name='newdisplayaccessr'),
